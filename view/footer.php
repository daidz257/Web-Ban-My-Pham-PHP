                            ...
                            <div class="widget-item">
                                <div class="widget-about">
                                    <a class="widget-logo" href="index.html">
                                        <img src="view/assets/images/logo.webp" width="95" height="68" alt="Logo">
                                    </a>
                    ...
                    <div class="modal-body">
                        <div class="product-action-view-content">
                            ...
                            <div class="modal-action-product">
                                <div class="thumb">
                                    <img src="view/assets/images/shop/modal1.webp" alt="Organic Food Juice" width="466" height="320">
                                </div>
                    ...
                    <div class="search-box-form-wrap">
                        ...
                        <form action="index.php?act=sanpham" method="post">
                            <div class="aside-search-form position-relative">
                                ...
                                <input name="kyw" id="SearchInput" type="search" class="form-control" placeholder="Search entire store…">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="product-single-thumb">
                                            <img src="view/assets/images/shop/quick-view1.webp" width="544" height="560" alt="Image-HasTech">
                                        </div>
        ...
        <aside class="aside-cart-wrapper offcanvas offcanvas-end" tabindex="-1" id="AsideOffcanvasCart" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="offcanvas-body">
                <ul class="aside-cart-product-list">
                    <li class="aside-product-list-item">
                        ...
                        <a href="product-details.html">
                            <img src="view/assets/images/shop/cart1.webp" width="68" height="84" alt="Image">
                    ...
                    <li class="aside-product-list-item">
                        <a href="#/" class="remove">×</a>
                        <a href="product-details.html">
                            <img src="view/assets/images/shop/cart2.webp" width="68" height="84" alt="Image">
                ...
                <a class="btn-total" href="index.php?act=viewcart">View cart</a>
